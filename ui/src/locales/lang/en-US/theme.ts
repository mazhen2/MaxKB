export default {
  ...
  defaultTip: 'The default is the GCode platform interface, supports custom settings',
  logoDefaultTip: 'The default is the GCode login interface, supports custom settings',
